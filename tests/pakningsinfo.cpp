...
TEST_CASE("Create class Pakningsinfo from node", "[Pakningsinfo]") {
  ...
  auto pakningsinfo = festlib::xml::get_pakningsinfo(node);
  REQUIRE(pakningsinfo[0].reflegemiddelmerkevare().compare(
              "ID_D9ECF4A9-FE22-401D-AA86-31ACA65EFAC2") == 0);
}
