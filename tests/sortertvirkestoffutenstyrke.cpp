...
TEST_CASE("Create Class from xml string", "[SortertVirkestoffUtenStyrke]")
{
  ...
  REQUIRE(sortering[0].second.compare("ID_A0DBC88E-864A-4231-BA8F-DFCA3D00F599") == 0);
}
