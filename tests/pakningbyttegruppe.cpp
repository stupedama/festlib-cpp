...
TEST_CASE("Create class PakningByttegruppe from node", "[PakningByttegruppe]") {
  ...
  REQUIRE(pakningbyttegruppe.refbyttegruppe().compare(
              "ID_BF16B775-2109-41A1-8369-2230FDE6B0EE") == 0);
