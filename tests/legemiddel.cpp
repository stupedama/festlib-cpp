...
TEST_CASE("Create Class from xml string", "[Legemiddel]") {
  ...
  Festlib fest{};
  fest.load_string(xml_merkevare);
  ...
  auto navnformstyrke = lm.navnformstyrke();
  REQUIRE(navnformstyrke.compare(
              "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg") == 0);
