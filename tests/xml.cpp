...
TEST_CASE("Load xml from string", "[xml]") {
  using namespace festlib;
  Festlib fest{};
...
TEST_CASE("Get the creation date of Fest xml", "[xml]") {
  using namespace festlib;
  ...
  std::string date = created_date(fest);

  REQUIRE(date.compare("2023-09-08T03:11:43") == 0);
}

TEST_CASE("Get exception for no match for end tag", "[xml]") {
  using namespace festlib;

  const char local_xml_string[] =
      "<?xml version='1.0' encoding='utf-8'?><FEST "
      "xmlns:xsd='http://www.w3.org/2001/XMLSchema' "
      "xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' "
      "xmlns='http://www.kith.no/xmlstds/eresept/m30/"
      ...
      "Healthcare</Produsent></ProduktInfo><Reseptgyldighet><Varighet>P1Y</"
      "Varighet></Reseptgyldighet></LegemiddelMerkevare></"
      "OppfLegemiddelMerkevare></FEST>";

  Festlib fest{};
  REQUIRE_THROWS_AS(fest.load_string(local_xml_string),
                    festlib::exceptions::BadDocument);
}

TEST_CASE("Check if the xml is really is fest xml", "[xml]") {
  using namespace festlib;

  const char local_xml_string[] =
      "<?xml version='1.0' encoding='utf-8'?><NO "
      "xmlns:xsd='http://www.w3.org/2001/XMLSchema' "
      "xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' "
      "xmlns='http://www.kith.no/xmlstds/eresept/m30/"
      "2014-12-01'><HentetDato>2023-09-08T03:11:43</"
      ...
      "Healthcare</Produsent></ProduktInfo><Reseptgyldighet><Varighet>P1Y</"
      "Varighet></Reseptgyldighet></LegemiddelMerkevare></"
      "OppfLegemiddelMerkevare></KatLegemiddelMerkevare></NO>";

  Festlib fest{};
  REQUIRE_THROWS_AS(fest.load_string(local_xml_string),
                    festlib::exceptions::BadFestFormat);
}
