...
TEST_CASE("Create class Markedsforingsdato from node", "[Markedsforingsinfo]") {
  ...
  auto markedsforingsinfo = festlib::xml::get_markedsforingsinfo(node);
  REQUIRE(markedsforingsinfo.markedsforingsdato().compare("2023-01-01") == 0);
}
