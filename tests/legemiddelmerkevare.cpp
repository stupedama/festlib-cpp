...
TEST_CASE("Create Class from xml string", "[LegemiddelMerkevare]") {
  ...
  festlib::xml::LegemiddelMerkevare merkevare =
      festlib::xml::get_legemiddelmerkevare(node);
  ...
  REQUIRE(varenavn.compare("Kodimagnyl Ikke-stoppende dak") == 0);

  std::string legemiddelformlang = merkevare.legemiddelformlang();
  REQUIRE(legemiddelformlang.compare("Tablett, filmdrasjert") == 0);
}

TEST_CASE("Create Set from LegemiddelMerkevare category",
          "[LegemiddelMerkevare]") {
  using festlib::Festlib;
...
TEST_CASE("Create container from LegemiddelMerkevare category",
          "[LegemiddelMerkevare]") {
  using festlib::Festlib;
  ...
  const char xml_string[] =
      ...
      "Healthcare</Produsent></ProduktInfo><Reseptgyldighet><Varighet>P1Y</"
      "Varighet></Reseptgyldighet></LegemiddelMerkevare></"
      "OppfLegemiddelMerkevare><OppfLegemiddelMerkevare><Id>ID_DE995772-8BBC-"
      "4164-8A0C-044CFC522794</Id><Tidspunkt>2023-06-05T03:11:16</"
      "Tidspunkt><Status V='A' DN='Aktiv oppføring' /><LegemiddelMerkevare "
      "xmlns='http://www.kith.no/xmlstds/eresept/forskrivning/2014-12-01'><Atc "
      "V='N02AJ07' S='2.16.578.1.12.4.1.1.7180' DN='Kodein og "
      "acetylsalisylsyre' /><NavnFormStyrke>Kodimagnyl Ikke-stoppende dak tab "
      "9,6 mg/500 mg/150 mg</NavnFormStyrke><Reseptgruppe V='B' "
  ...
  auto container =
      festlib::xml::get_category<festlib::xml::LegemiddelMerkevare>(
          node, "KatLegemiddelMerkevare", [](const pugi::xml_node &n) {
            festlib::xml::LegemiddelMerkevare val{
                festlib::xml::get_legemiddelmerkevare(n)};
            return val;
          });

  REQUIRE(container[0].legemiddelformlang().compare("Tablett, filmdrasjert") ==
          0);
  REQUIRE(container[1].varenavn().compare("Kodimagnyl Ikke-stoppende dak") ==
          0);
